                ...
                <div className="clearfix">
                  ...
                  <div className="float-right">
                    ...
                    <div className="fluid-container">
                      <h3 className="font-weight-medium text-right mb-0 text-dark">{this.state.addr}</h3>
                    </div>
                  </div>
                </div>
              ...
              <div className="card-body">
                <div className="clearfix">
                  ...
                  <div className="float-right">
                    ...
                    <div className="fluid-container">
                      <h3 className="font-weight-medium text-right mb-0 text-dark">{this.state.uid}</h3>
                    </div>
                  </div>
                </div>
                <p className="text-muted mt-3 mb-0">
              ...
              <div className="card-body">
                <div className="clearfix">
                  ...
                  <div className="float-right">
                    ...
                    <div className="fluid-container">
                      <h3 className="font-weight-medium text-right mb-0 text-dark">{this.state.name}</h3>
                    </div>
                  </div>
                </div>
                <p className="text-muted mt-3 mb-0">
              ...
              <div className="card-body">
                <div className="clearfix">
                  ...
                  <div className="float-right">
                    ...
                    <div className="fluid-container">
                      <h3 className="font-weight-medium text-right mb-0 text-dark">{this.state.location}</h3>
                    </div>
                  </div>
                </div>
                <p className="text-muted mt-3 mb-0">
